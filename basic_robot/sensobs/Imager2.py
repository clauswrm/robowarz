...
class Imager:
    ...
    def __init__(self, fid='', image=Image.Image(), width=100, height=100, background='black', mode='RGB'):
    ...
    def dump_image(self, fid, _type='gif'):
        fname = fid.split('.')
        _type = fname[1] if len(fname) > 1 else _type
        self.image.save(fname[0] + '.' + _type, format=_type)
